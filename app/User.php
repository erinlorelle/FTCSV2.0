...
//class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'username', 'first_name', 'last_name', 'start_year','degree', 'institution', 'qualifications', 'credentials', 'department', 'college', 'type', 'title'
    ...
    public function major(){
        ...
        return $this->belongsToMany('App\Major','user_majors');
    }
