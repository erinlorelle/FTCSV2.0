        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" style="color: greenyellow;padding-right: 63px">Dean
...
<div class="container">
        ...
        <div class="row">
            <div class="col-sm-8">
                <br><br>
                <h2 style="color: midnightblue">Dean Homepage</h2>
                <h2 class="mt-4">Welcome to the Dean homepage for the ETSU Faculty Teaching Credentials System (FTCS)</h2>
                ...
                <table id="myTable">
                    ...
                    <tr><td><a href="credAppal" style="font-size: larger">Appalachian Studies</a></td></tr>
                    <tr><td style="padding-left: 20px">0 Courses Need Credentials</td></tr>
                    <tr><td><a href="credAccounting" style="font-size: larger">Accounting</a></td></tr>
                    <tr><td style="padding-left: 20px">1 Courses Need Credentials</td></tr>
                    <tr><td><a href="credBio" style="font-size: larger">Biostatistics & Epidemiology</a></td></tr>
                    <tr><td style="padding-left: 20px">0 Courses Need Credentials</td></tr>
                    <tr><td><a href="credAud" style="font-size: larger">Audio & Spch-Lang Pathology</a></td></tr>
                    <tr><td style="padding-left: 20px">0 Courses Need Credentials</td></tr>
                    <tr><td><a href="credCouns" style="font-size: larger">Counseling and Human Services</a></td></tr>
                    <tr><td style="padding-left: 20px">0 Courses Need Credentials</td></tr>
                </table>
