...
--}}
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8">
                <br><br>
                <h2 style="color: midnightblue">Credential Officer Department Page</h2>
                <h3 class="mt-4">Select a department below to manage credential officers</h3>
