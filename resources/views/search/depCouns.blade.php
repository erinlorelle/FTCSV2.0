...
@section('content')
    ...
    <div class="container" style="position: center">
        ...
        <br><br>
        <h2 style="position: center">Counseling and Human Services' Faculty List</h2>
        <br>
        ...
        <section id="contact">
            ...
            <table id="myTable">
                ...
                <tr><td><a href="users/6">Lincoln, Abraham</td><td>Counseling and Human Services</td><td>Clemmer College</td>
