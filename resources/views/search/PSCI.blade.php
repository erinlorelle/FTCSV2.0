...
@section('content')
    ...
    <div class="container" style="position: center">
        ...
        <br><br>
        <h2 style="position: center">PSCI 3350's Teaching Faculty List</h2>
        <br>
        ...
        <section id="contact">
            ...
            <table id="myTable">
                ...
                <tr><td><a href="users/5">McFly, Marty</td><td>Pol Sc, Intl Affairs & Pub Adm</td><td>Arts & Sciences</td>
