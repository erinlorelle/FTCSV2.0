...
@section('content')
    ...
    <div class="container" style="position: center">
        ...
        <br><br>
        <h2 style="position: center">ECED 4018's Teaching Faculty List</h2>
        <br>
        ...
        <section id="contact">
            ...
            <table id="myTable">
                ...
                <tr><td><a href="users/6">Lincoln, Abraham</td><td>Early Childhood Education</td><td>Clemmer College</td>
